    ...
    return (
        <div className="max-w-3xl mx-auto dark:text-white">
            <div className="flex items-center mb-8">
                ...
                <h2 className="text-3xl font-bold text-gray-800 dark:text-white">Ajustes</h2>
            </div>

            <div className="space-y-6">
                {/* Perfil del Usuario */}
                <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-md">
                    <h3 className="text-xl font-bold text-teal-700 dark:text-teal-400 mb-4 border-b dark:border-gray-700 pb-2">Información de Cuenta</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        {user.patientCode && (
                            <div>
                                <p className="text-sm text-gray-500 dark:text-gray-400">Código de Vinculación</p>
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-md">
                    <h3 className="text-xl font-bold text-teal-700 dark:text-teal-400 mb-4 border-b dark:border-gray-700 pb-2">Preferencias</h3>

                    {/* Toggle Modo Oscuro */}
                    <div className="flex justify-between items-center mb-6">
                        <div>
                            <p className="font-bold text-lg">Modo Oscuro</p>
                            <p className="text-sm text-gray-500 dark:text-gray-400">Cambia la apariencia para descansar la vista</p>
                        </div>
                        <button
                    ...
                    <div className="flex justify-between items-center">
                        <div>
                            <p className="font-bold text-lg">Idioma</p>
                            <p className="text-sm text-gray-500 dark:text-gray-400">Selecciona el idioma de la interfaz</p>
                        </div>
                ...
                <div className="bg-red-50 dark:bg-red-900/20 p-6 rounded-2xl border border-red-100 dark:border-red-900">
                    <h3 className="text-red-700 dark:text-red-400 font-bold mb-2">Sesión</h3>
